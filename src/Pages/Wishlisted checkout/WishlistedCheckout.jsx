...
export default function WishlistedCheckout() {
    const { id } = useParams();
    ...
    const { data: selectedForCheckout, isLoading } = useQuery({
        ...
        queryFn: async () => {
            const { data } = await axiosCommon.get(`/selected-for-checkout-wishlist/${id}`);
            return data;
        }
    })
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="lg:ml-6 mt-4 lg:mt-0 lg:w-1/2">
                        ...
                        <p className='mt-6 font-bold font-poppins'>Select Your guide</p>
